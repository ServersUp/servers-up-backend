...
### Changed
- **Website URL** — the live status page and install docs are at [serversup.armasn.dev](https://serversup.armasn.dev/). Bot `/help` and related links point there.

## v1.3 — 2026-07-13

### Added
- **Live status on the website** — check World of Warcraft and Final Fantasy XIV **UP/DOWN** on [serversup.armasn.dev](https://serversup.armasn.dev/) without adding the Discord bot. Pick a game and region to browse every listed realm.
